...
1.  **Shared immutable inputs** (avoid duplicating large objects across
    workers)
...
If your workload is “apply a function over columns” or “lapply over a
list”, `shard` provides convenience wrappers that handle sharing and
buffering automatically while still running through the supervised
runtime.
