...
#> Ncells 1045679 55.9    1343934 71.8  1343934 71.8
#> Vcells 3082096 23.6    8388608 64.0  5107400 39.0
#> 
#> $gc_after
#>           used (Mb) gc trigger (Mb) max used (Mb)
#> Ncells 1045716 55.9    1343934 71.8  1343934 71.8
#> Vcells 3182143 24.3    8388608 64.0  5107400 39.0
#> 
# }
```
